...
{	
	...
	var $dbname="jgwesterfield-TamuDriver";      // name of the database
	var $user = "jgwesterfield";        // username to log in to database
	var $pass="Whoop19!";          // password to log in to database
